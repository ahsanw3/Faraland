      ...
      <div className='max-w-[1100px]  mb-24 mr-auto ml-auto '>
        ...
        <div className='flex flex-col md:flex-row  max-w-[1500px] w-90%  '>
          ...
          <div className='lg:w-[53%]  ml-8 '>
            <h1 className='text-4xl font-bold  text-white '>{heroesData.heading}</h1>
            <p className=' text-white text-2xl mt-3 mb-4'>{heroesData.percentage}</p>
            <div className=''>
              ...
              {heroesData.features.map((feature, i) => {
                        return (
                          <div className=' text-white w-[30%] text-xl font-semibold heroClass pt-8 pb-4'>{feature.name}</div>
                        );
                    })}
               </div>
            </div>
