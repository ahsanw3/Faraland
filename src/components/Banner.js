...
import bg from "../images/home.bb5cafa8.png"
import dragon from "../images/orc.465371dc.png"
import jara from '../images/faraland.svg'
import humanWarrior from '../images/human.83a89a9e.png'
...
function Banner() {
  return (
    ...
    <div className='h-full absolute left-[5%] bottom-[10%] lg:top-20 lg:left-[10%] top-10 xl:left-[13%] 2xl:left-[14%] '>
        <img src={dragon} alt="" className='h-3/4 mb-5 ' />
    </div>
    <div className='h-full absolute right-[10%] bottom-0 w-[70%] flex justify-end items-end xl:right-[12%] 2xl:right-[14%]'>
        <img src={jara} alt="" className=' w-[35%] ml-20 mb-7 absolute right-[10%] top-[10%] xl:w-[27%] xl:right-[12%]  2xl:right-[14%]' />
        <img src={humanWarrior} alt="" className='h-2/4' />
    </div>
    <div className='w-full absolute bottom-0 '>
        <img src={bannerBar} alt="" className='w-full' />
    </div>
    <div className='w-4/5 absolute ml-[10%] xl:w-2/4 xl:ml-[25%] -bottom-6 md:-bottom-10 lg:-bottom-16  xl:-bottom-18 '>
            <img src={bannerPlaceholder} alt="" className='w-full'/>
    </div>
    <div className='w-4/5 absolute ml-[10%] xl:w-2/4 xl:ml-[25%] -bottom-6 md:-bottom-10 lg:-bottom-16  xl:-bottom-18 flex flex-col justify-between items-center'>
      ...
      <div className='flex justify-between w-[70%] mb-[3%] md:mb-[4%]'>
        <h4 className='text-white text-xs invisible sm:visible font-[400px] text-[18px] font-americanCapitan'>20000/20000</h4>
        <h4 className='text-white text-xs invisible sm:visible font-[400px] text-[18px] font-americanCapitan'>20000/20000 SUMMONED</h4>
      </div>
