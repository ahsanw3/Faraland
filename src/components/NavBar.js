    ...
    return (
        <div>
            <div className='w-full h-full z-10  absolute top-0 bg-inherit'>
                ...
                <div className='absolute top-0 w-full'>
                    <div className='flex justify-between items-center w-[97%] bg-inherit max-w-[1200px]  mr-auto ml-auto '>
                        ...
                        {!openMenu && 
                        <div className='h-20 border-red-900 flex items-center '>
            ...
            {openMenu &&  <div className='h-[100%] w-full flex justify-end lg:w-0 lg:invisible lg:h-0 absolute top-0 border z-50'>
                   <button onClick={handleOpenMenu} className="w-full sm:w-[55%] border border-red-900 bg-black opacity-70">
                    ...
                    <div className='w-[900px] sm:w-[45%] bg-[#444165] h-full flex flex-col items-center '>
                        ...
                        <a className='mt-7' href="/">Heroes</a>
                        <a className='mt-7' href="/">Demi Heroes</a>
                        <a className='mt-7' href="/">Equipment</a>
                        <a className='mt-7' href="/">Materials</a>
                        <a className='mt-7' href="/">Staking</a>
                        <a className='mt-7' href="/">Guild</a>
                        <a className='mt-7' href="/">Summon Demi</a>
                        <a className='mt-7' href="/">EVENT</a>
                        <a className='mt-7' href="/">WIKI</a>
                        <a className='mt-7' href="/">blog</a>
                    </div>
            </div>
            }
